...
alindicu.MariageViewModel = function (
    ...
    self.adresseMairie = adresseMairie;
    self.mairieParkingLabel = mairieParkingLabel;
    ...
    self.parkingRestaurant = parkingRestaurant;
    self.disclaimerMajHeures = disclaimerMajHeures;
};